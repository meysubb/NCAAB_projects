...
library("sm")
getwd()
setwd("C:/Users/Meyappan/Desktop/NCAAB_app/")
################# LOAD DATA
start.time <- Sys.time()
# Only Two digits
options(digits=8)
# Load aggregate player data
agg.player <- read.csv(file="data/summary_player_data.tsv", sep="\t", header=TRUE, row.names=1, na.strings="?",stringsAsFactors = FALSE)
...
ind.player <- read.csv(file="data/player_data.tsv", sep="\t", header=TRUE, row.names=NULL, na.strings="?",stringsAsFactors = FALSE)
...
ind.team <- read.csv(file="data/team_data.tsv", sep="\t", header=TRUE, row.names=NULL, na.strings="?",stringsAsFactors = FALSE)
...
agg.team["459","opp_team_fgpct"] <- recalc_opp_stat(459,agg.team,ind.team,var1="team_fgm",var2="team_fga",fun="createavg") * 100
agg.team["270","opp_team_fgpct"] <- recalc_opp_stat(270,agg.team,ind.team,var1="team_fgm",var2="team_fga",fun="createavg") * 100
#agg.team["365","opp_team_fgpct"] <- recalc_opp_stat(365,agg.team,ind.team,var1="team_fgm",var2="team_fga",fun="createavg") * 100
agg.team["270","opp_team_three_fgpct"] <- recalc_opp_stat(270,agg.team,ind.team,var1="team_three_fgm",var2="team_three_fga",fun="createavg") * 100
...
#agg.team["454","opp_team_rebavg"] <- recalc_opp_stat(454,agg.team,ind.team,var1="team_rebavg",fun="avg")
